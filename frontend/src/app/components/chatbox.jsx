    ...
    return (
        <div className="p-2 border-2 border-gray-300 rounded-md bg-gray-900 h-full">
            <div className="w-full h-[calc(100%-50px)] py-1 mb-2 flex flex-col gap-2 text-sm">
                {userMessage && <div className="w-[80%] bg-gray-200 rounded-sm p-1 px-2 ml-auto mt-0 text-black ">
                    {userMessage}
                </div>}
                {botMessage && <div className="w-[80%] bg-blue-500 rounded-sm p-1 px-2 mr-auto mt-0 text-white">
                    {botMessage}
                </div>}
            </div>
